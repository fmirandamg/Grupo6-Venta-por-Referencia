      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">            
            ...
            <li><a href="negocio.html">El Negocio</a></li>
            <li><a href="pregunta.html">Preguntas Frecuentes</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
   ...
   <div class="starter-template">   
    ...
    <!--Cabecera-->
      ...
      <div id="formulario">
        ...
        <br>
         <form method="post" action="reg_perfil">
            <label>Nombres</label>
            <br>
            ...
            <label>Fecha</label>
            <br>
            <input type="date" class="fec" name="fecha" value=""/>
            <br><br>
