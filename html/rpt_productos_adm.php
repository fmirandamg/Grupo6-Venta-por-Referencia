    ...
    <!--Cabecera-->
      ...
      <!--Pantalla Criterio-->
        ...
        <div id="Buscador">
         ...
         <h4>Criterio de Descripcion</h4>
         <form method="post" action="bus_nom">
            <select>
              <option value="tod">Todos</option>
              <option value="Cedula">Codigo</option>
              <option value="Nombres">Descripcion</option>
            </select>
      ...
      <!--Tabla de Resultados-->
        <div id="repor_cont">
          <table class="rep_cab" >
               ...
               <thead >
                  <tr >
                     <th class="tbl_cod_rep2" >Codigo</th>
                     <th class="tbl_nombre_rep3">Descripcion</th>
